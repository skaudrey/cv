...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item I proposed three patents relate to anti-fraud detection, identification detection and intention detection. The patents have been accepted by Meituan-Dianping, and will be handed by them.\footnote{\url{https://github.com/skaudrey/cv/blob/master/patent/list.png}}.
	\end{itemize*}
...
\begin{itemize}
	...
	\item 
	\headerrow
		{3rd prize, The 13th MCM of Master\footnote{\url{http://gmcm.seu.edu.cn/}}}
		{\emph{90/2016}}
	\item 
	\headerrow
		{Excellent Graduate}
	...
	\item 
	\headerrow
		{2nd Prize, COMAP's MCM\footnote{\url{https://www.comap.com/undergraduate/contests/}}}
		{\emph{02/2015}}
\end{itemize}
